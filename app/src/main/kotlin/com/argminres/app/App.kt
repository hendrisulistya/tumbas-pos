...
import com.argminres.app.presentation.home.HomeScreen
import com.argminres.app.presentation.sales.SalesScreen
import com.argminres.app.presentation.showcase.ShowcaseScreen
import com.argminres.app.presentation.backup.BackupScreen
import com.argminres.app.presentation.activation.ActivationScreen
import com.argminres.app.presentation.activation.PostActivationScreen
import com.argminres.app.presentation.reporting.ReportingScreen
import com.argminres.app.presentation.sales.SalesOrderScreen
import com.argminres.app.presentation.settings.SettingsScreen
            ...
            Scaffold(
                ...
                NavHost(
                    ...
                    composable(Screen.StoreSettings.route) {
                        com.argminres.app.presentation.settings.store.StoreSettingsScreen(
                            onNavigateBack = { navController.popBackStack() }
                        )
                    }
                    ...
                    composable(Screen.Reporting.route) {
                        com.argminres.app.presentation.reporting.ReportingScreen(
                            onNavigateBack = { navController.popBackStack() },
                            onNavigateToEndOfDay = { navController.navigate(Screen.EndOfDay.route) }
                        )
                    }
                    ...
                    composable(Screen.RestoreStore.route) {
                        com.argminres.app.presentation.activation.RestoreStoreScreen(
                            onNavigateBack = {
                    ...
                    composable(Screen.PostActivation.route) {
                        com.argminres.app.presentation.activation.PostActivationScreen(
                            onComplete = {
                                navController.navigate(Screen.Login.route) {
                    ...
                    composable(Screen.About.route) {
                        com.argminres.app.presentation.settings.AboutScreen(
                            onNavigateBack = { navController.popBackStack() }
                        )
                    }
                    
                    composable(Screen.EmployerManagement.route) {
                        com.argminres.app.presentation.employer.EmployerManagementScreen(
                            onNavigateBack = { navController.popBackStack() }
                        )
                    }
                
                    composable(Screen.AuditLog.route) {
                        com.argminres.app.presentation.audit.AuditLogScreen(
                            onNavigateBack = { navController.popBackStack() }
                        )
                    }
                    
                    composable(Screen.EndOfDay.route) {
                        com.argminres.app.presentation.endofday.EndOfDayScreen(
                            onNavigateBack = { navController.popBackStack() }
                        )
                    }
                    
                    composable(Screen.WorkInProcess.route) {
                        com.argminres.app.presentation.wip.WorkInProcessScreen(
                            onNavigateBack = { navController.popBackStack() },
                            onNavigateToEndOfDay = { navController.navigate(Screen.EndOfDay.route) }
                        )
                    }
