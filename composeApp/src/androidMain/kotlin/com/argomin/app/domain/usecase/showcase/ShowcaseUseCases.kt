package com.argomin.app.domain.usecase.showcase
...
class GetShowcaseInventoryUseCase(
    ...
    operator fun invoke(): Flow<List<com.argomin.app.data.local.dao.DishWithCategory>> = dishRepository.getDishesWithStock()
}
