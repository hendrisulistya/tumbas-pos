package com.argomin.app.domain.usecase.session
...
import com.argomin.app.domain.repository.WasteRecordRepository
...
import com.argomin.app.domain.repository.SalesOrderRepository
...
class EndOfDayUseCase(
    ...
    private val ingredientUsageRepository: com.argomin.app.domain.repository.IngredientUsageRepository,
    private val ingredientWasteRecordRepository: IngredientWasteRecordRepository,
    private val dishRepository: DishRepository,
    private val salesOrderRepository: com.argomin.app.domain.repository.SalesOrderRepository,
    private val reportingRepository: com.argomin.app.domain.repository.ReportingRepository
) {
    suspend operator fun invoke(
        ...
        val ingredientUsageRecords = mutableListOf<com.argomin.app.data.local.entity.IngredientUsageEntity>()
        ...
        remainingIngredients.forEach { input ->
            ...
            if (validUsedQuantity > 0) {
                ingredientUsageRecords.add(
                    com.argomin.app.data.local.entity.IngredientUsageEntity(
...
sealed class EndOfDayResult {
    data class Success(
        ...
        val ingredientUsageRecords: List<com.argomin.app.data.local.entity.IngredientUsageEntity>,
