package com.argomin.app.domain.usecase.reporting
...
data class DashboardData(
    val salesSummary: Flow<List<com.argomin.app.domain.model.SalesSummary>>,
    val topProducts: Flow<List<com.argomin.app.domain.model.TopProduct>>,
    val lowStock: Flow<List<com.argomin.app.domain.model.LowStockProduct>>,
...
data class SessionReportData(
    val ingredientUsage: Flow<List<com.argomin.app.data.local.entity.IngredientUsageEntity>>,
    val dishUsage: Flow<List<com.argomin.app.data.local.entity.WasteRecordEntity>>
)
...
data class AggregatedUsageData(
    val ingredientUsage: Flow<List<com.argomin.app.domain.model.AggregatedIngredientUsage>>,
    val dishUsage: Flow<List<com.argomin.app.domain.model.AggregatedDishUsage>>
)
...
class GetCashierPerformanceUseCase(private val reportingRepository: ReportingRepository) {
    operator fun invoke(startDate: Long, endDate: Long): Flow<List<com.argomin.app.domain.model.CashierDishSales>> {
