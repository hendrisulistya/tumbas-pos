...
import com.argomin.app.data.local.dao.SalesOrderDao
...
class SalesOrderRepositoryImpl(
    ...
    override suspend fun getSoldQuantitiesByDish(startDate: Long, endDate: Long): List<com.argomin.app.data.local.dao.DishSoldQuantity> {
