...
import com.argomin.app.data.local.dao.ReportingDao
import com.argomin.app.domain.model.LowStockProduct
import com.argomin.app.domain.model.SalesSummary
import com.argomin.app.domain.model.TopProduct
import com.argomin.app.domain.repository.ReportingRepository
...
class ReportingRepositoryImpl(
    ...
    override fun getIngredientUsageBySession(sessionId: Long): Flow<List<com.argomin.app.data.local.entity.IngredientUsageEntity>> {
        return reportingDao.getIngredientUsageBySession(sessionId)
    }

    override fun getDishUsageBySession(sessionId: Long): Flow<List<com.argomin.app.data.local.entity.WasteRecordEntity>> {
        return reportingDao.getDishUsageBySession(sessionId)
    }

    override fun getAggregatedIngredientUsage(startDate: Long, endDate: Long): Flow<List<com.argomin.app.domain.model.AggregatedIngredientUsage>> {
        return reportingDao.getAggregatedIngredientUsage(startDate, endDate)
    }

    override fun getAggregatedDishUsage(startDate: Long, endDate: Long): Flow<List<com.argomin.app.domain.model.AggregatedDishUsage>> {
        return reportingDao.getAggregatedDishUsage(startDate, endDate)
    }

    override fun getAggregatedUsageReport(startDate: Long, endDate: Long): Flow<com.argomin.app.domain.model.AggregatedUsageState> {
        return combine(
            getAggregatedIngredientUsage(startDate, endDate),
            getAggregatedDishUsage(startDate, endDate)
        ) { ingredients, dishes ->
            com.argomin.app.domain.model.AggregatedUsageState(ingredients, dishes)
        }
    }

    override fun getDishSalesByCashier(startDate: Long, endDate: Long): Flow<List<com.argomin.app.domain.model.CashierDishSales>> {
