package com.argomin.app.data.local.dao
...
interface ReportingDao {
    @Query("""
        ...
        ORDER BY date DESC
    """)
    fun getDailySalesSummary(startDate: Long, endDate: Long, cashierId: Long?): Flow<List<com.argomin.app.domain.model.SalesSummary>>
    ...
    @Query("""
        ...
        LIMIT :limit
    """)
    fun getTopSellingDishes(startDate: Long, endDate: Long, limit: Int, cashierId: Long?): Flow<List<com.argomin.app.domain.model.TopProduct>>
    ...
    @Query("""
        ...
        LIMIT :limit
    """)
    fun getTopSellingPackages(startDate: Long, endDate: Long, limit: Int, cashierId: Long?): Flow<List<com.argomin.app.domain.model.TopProduct>>
